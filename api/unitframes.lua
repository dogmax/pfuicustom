...
function pfUI.uf:UpdateConfig()
  ...
  f.hpLeftText:SetPoint("CENTER",f.hp.bar, "CENTER", 0, 1)  -- [Grylls Mod]
  ...
  f.hpCenterText:SetPoint("TOPLEFT",f.hp.bar, "TOPLEFT", 0, 23) -- [Grylls Mod]
  f.hpCenterText:SetPoint("BOTTOMRIGHT",f.hp.bar, "BOTTOMRIGHT", 0, 23) -- [Grylls Mod]
  ...
  f.powerRightText:SetPoint("TOPLEFT",f.power.bar, "TOPLEFT", 0, 1) -- [Grylls Mod]
  f.powerRightText:SetPoint("BOTTOMRIGHT",f.power.bar, "BOTTOMRIGHT", 0, 1) -- [Grylls Mod]
...
function pfUI.uf:GetStatusValue(unit, pos)
  ...
  if config == "unit" then
    -- [Grylls mod]
    if string.len(UnitName(unitstr)) > 12 then
      ...
      local unitname = abbrevCache[UnitName(unitstr)]
      local name = unit:GetColor("unit") .. unitname
